      ...
      <div className="panel-container">
        <div className="question-source-container">
          ...
          <FromCambridgePanel
            ...
            setQuestionYear={setQuestionYear}
          />
        </div>
      </div>
    </>
  ...
  return (
    <>
      <div className="question-specifier">
        <p className="qs-pa">
          Is this question from a Cambridge International AS and A Level Past
          Paper?{" "}
        </p>
        ...
        <div className="input-grid">
          ...
          <div className="qgu-answer">
            <input
              ...
              type="text"
              className="qgu-answer-input"
            />
            <input
              list="answer-type-qgu"
              placeholder="Answer Type"
              value={answerType}
              onChange={(e) => setAnswerType(e.target.value)}
              type="text"
              className="qgu-answer-type"
            />
...
function QuestionFinalPanel() {
  ...
  const logQuestionSource = async () => {
    ...
    let questionIDNumYearVariant =
      "_" + questionNumber + "_" + questionIDYear + "_" + questionVariant;
    ...
    await Axios.post(`${BASE}/addQuestion/getQuestionInfo`, {
      ...
      .then((res) => {
        ...
        Axios.post(`${BASE}/addQuestion`, {
          ...
          questionsFiguresGrid: Object.values(questionObject).map(
            (question) => question.figureText
          ),
          answersTypeGrid: Object.values(questionObject).map(
            (question) => question.answerType
          ),
          marksGrid: Object.values(questionObject).map(
            (question) => question.marksText
          ),
          answersGrid: Object.values(questionObject).map(
  ...
  return (
    <div className="question-final-panel">
      ...
      <QuestionAndCorrespondingAnswerPanel
        logQuestionSource={logQuestionSource}
